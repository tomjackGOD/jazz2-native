...
namespace nCine
{
	...
	RenderCommand* RenderCommandPool::Add(BackendShaderProgram* shaderProgram)
	{
	...
	RenderCommand* RenderCommandPool::Retrieve(BackendShaderProgram* shaderProgram)
	{
	...
	RenderCommand* RenderCommandPool::RetrieveOrAdd(BackendShaderProgram* shaderProgram, bool& commandAdded)
	{
